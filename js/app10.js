...
$('.card').on('click', function() {
  ...
  if (clickedCardClass === 'card open show') {
...
// $('li').addClass('match'); // adds to all <i> element the class match WORKING
var matchedClassI = $('.'+ openCards[0]); // has to be a dot before
var parentElement = $(matchedClassI).parent('li');
